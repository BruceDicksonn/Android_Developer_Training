 ...
 */
public class FragmentDatePicker extends DialogFragment implements android.app.DatePickerDialog.OnDateSetListener {
    ...
    public static FragmentDatePicker newInstance(String param1, String param2) {
    ...
    public void onDateSet(DatePicker datePicker, int year, int month, int day) {
        TabFragmentDate.getDateCaptured(year,month,day);
    }
}